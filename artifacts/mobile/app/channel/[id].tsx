...
export default function ChannelScreen() {
  ...
  const shorts = VIDEOS.filter((v) => v.scholarId === scholar.id && v.type === "short");
          ...
          {CHANNEL_TABS.map((tab) => (
            ...
            >
              <Text
                style={[
                  styles.tabText,
                  { color: activeTab === tab ? colors.primary : colors.mutedForeground, fontWeight: activeTab === tab ? "700" : "400" },
                ]}
              >
                {tab}
              </Text>
